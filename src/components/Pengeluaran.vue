  ...
  <div>
    ...
    <v-card
      ><v-card-title class="mb-5">
        Pengeluaran Bulanan <v-spacer></v-spacer>
    ...
    <v-card class="mt-5"
      ><v-card-title class="mb-5">
        Pengeluaran Tahunan <v-spacer></v-spacer>
  ...
  methods: {
    print_tahunan() {
      var WinPrint = window.open(
        "http://127.0.0.1:8000/pengeluaran-tahunan/" +
          this.from +
          "/" +
          this.to +
          "/" +
    ...
    print_bulanan() {
      var WinPrint = window.open(
        "http://127.0.0.1:8000/pengeluaran-bulanan/" +
          this.tahun +
          "/" +
          sessionStorage.getItem("id"),
        "_blank"
    ...
    filterBulanan() {
      ...
      this.get_pengeluaran_bulanan(res);
    ...
    filterTahunan() {
      ...
      this.get_pengeluaran_tahunan(res, res1);
        ...
        .then((response) => {
          switch (data) {
            case "pengeluaran_bulanan":
              ...
              for (let i = 0; i < this.pengeluaran_bulanan.length; i++) {
                this.labels_bulanan.push(this.pengeluaran_bulanan[i].Bulan);
                this.makanan_bulanan.push(this.pengeluaran_bulanan[i].Makanan);
                this.sidedish_bulanan.push(
                  this.pengeluaran_bulanan[i].Sidedish
                );
                this.minuman_bulanan.push(this.pengeluaran_bulanan[i].Minuman);
              }
              this.bulananData = {
            ...
            case "pengeluaran_tahunan":
              ...
              for (let i = 0; i < this.pengeluaran_tahunan.length; i++) {
                this.labels_tahunan.push(this.pengeluaran_tahunan[i].Tahun);
                this.makanan_tahunan.push(this.pengeluaran_tahunan[i].Makanan);
                this.sidedish_tahunan.push(
                  this.pengeluaran_tahunan[i].Sidedish
                );
                this.minuman_tahunan.push(this.pengeluaran_tahunan[i].Minuman);
              }
              this.tahunanData = {
          ...
          console.log(this.pengeluaran_bulanan);
          this.load = false;
        })
        .catch((error) => {
          console.log(error);
